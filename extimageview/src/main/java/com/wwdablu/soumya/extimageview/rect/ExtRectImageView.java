    ...
    public void crop(@Nullable ResultCallBack<Void> resultCallBack) {
        ...
        getOriginalBitmap(new ResultCallBack<Bitmap>() {
            ...
            public void onComplete(Bitmap data) {
                mExecutorService.execute(new OriginalBitmapCropper(data, mDisplayedBitmap, mFrameRect, new ResultCallBack<Bitmap>() {
                    @Override
                    public void onComplete(Bitmap originalCropped) {

                        saveOriginalBitmap(originalCropped, new ResultCallBack<Void>() {
                            @Override
                            public void onComplete(Void data) {

                                mExecutorService.execute(new DisplayBitmapCropper(mDisplayedBitmap, mFrameRect, new ResultCallBack<Bitmap>() {
                                    @Override
                                    public void onComplete(Bitmap data) {
