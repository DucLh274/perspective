    ...
    public void crop(@Nullable ResultCallBack<Void> resultCallBack) {
        ...
        getOriginalBitmap(new ResultCallBack<Bitmap>() {
            ...
            public void onComplete(Bitmap data) {
                mExecutorService.execute(new OriginalBitmapCropper(data, mDisplayedBitmap, mAnchorPoints, new ResultCallBack<Bitmap>() {
                    @Override
                    public void onComplete(Bitmap transformedOriginal) {
                        saveOriginalBitmap(transformedOriginal, new ResultCallBack<Void>() {
                            @Override
                            public void onComplete(Void data) {
                                transformedOriginal.recycle();
                                mExecutorService.execute(new DisplayBitmapCropper(mDisplayedBitmap, mAnchorPoints, new ResultCallBack<Bitmap>() {
                                    @Override
                                    public void onComplete(Bitmap data) {
